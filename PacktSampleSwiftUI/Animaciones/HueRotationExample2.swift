...
struct HueRotationExample2: View {
    @State private var hueRotation = false
    let backgrounds = ["img1","img2","img3","img4","img5","img6","img7","img8","img9",
                       "img10","img11","img12","img13"].shuffled()
...
struct HueRotationExample2_Previews: PreviewProvider {
